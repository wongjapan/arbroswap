...
export default function LocLocAsstLiqBox(props) {
  return (
    <>
      <div className="L_app1_In_box">
        <div class="box_1 clear">
          ...
          <div class="L_App1_img_top_right_title_liq  fl-left">
            <p>{props.coinname}</p>
          ...
          <div className="L_App1_view_left_liq fl-right">
            <span>View</span>
            <a href="#">
