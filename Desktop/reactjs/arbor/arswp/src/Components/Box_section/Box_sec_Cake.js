...
export default function Box_sec_Cake() {
  return (
    <>
      <div className="L_app2_In_box">
        <div>
          <div class="box_section_img1 fl-left">
            <img src="/img/panswap.png" alt="" />
          </div>
          <div class="box_section_name1 fl-left">
            <span className="box_section_name_1">CAKE</span>
            <br />
            <span className="box_section_name_2">Pancake</span>
          </div>
          ...
          <div class="box_section_name3 fl-right">
            <span className="box_section_unlocks_1">Unlocks on</span>
            <img src="/img/Ques.png" alt="" />
            <br />
