...
export default function Box_sec_Vgx() {
  return (
    <>
      <div className="L_app2_In_box">
        <div>
          <div class="box_section_img1 fl-left">
            <img src="/img/Voyager Token (VGX) (3).png" alt="" />
          </div>
          <div class="box_section_name1 fl-left">
            <span className="box_section_name_1">VGX</span>
            <br />
            <span className="box_section_name_2">Voyager</span>
          </div>
