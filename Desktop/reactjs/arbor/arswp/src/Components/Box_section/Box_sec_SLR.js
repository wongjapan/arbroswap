...
export default function Box_sec_SLR() {
  return (
    <>
      <div className="L_app2_In_box">
        <div>
          <div class="box_section_img1 fl-left">
            <img src="/img/Solarcoin (Slr).png" alt="" />
          </div>
          <div class="box_section_name1 fl-left">
            <span className="box_section_name_1">SLR</span>
            <br />
            <span className="box_section_name_2">Solaris</span>
          </div>
