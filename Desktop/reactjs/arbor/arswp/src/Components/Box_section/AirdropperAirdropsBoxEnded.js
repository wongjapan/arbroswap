...
export default function AirdropperAirdropsBoxEnded(props) {
    ...
    <Link to="/timed/boxlive">
      <>
        <div className="In_box">
          ...
          <div className="Airdrop_box6_col_2 clear">
            <div className="bottom-title-left_bi fl-left">Ended</div>
            <div className="Air_arbor_bottom-title-right_bi fl-right">
              00h : 00Min : 00s
            </div>
          </div>
        </div>
