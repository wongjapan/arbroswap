...
export default function UserPanel4(props) {
  return (
    <>
      <div className="app10_contain2 fl-right">
        ...
        <div className="app10_contain2_section1 clear">
          ...
          <div className="app10_contain2_section1_inner_a fl-left">Vested</div>
          <div className="app10_contain2_section1_inner_b fl-right">
            {props.vested}
          </div>
          <div className="app10_hr_pad clear">
          ...
          <div className="app10_contain2_section1_inner_a">
            Available to Claim
          </div>
          <div className="clear"></div>
        ...
        <div class="contain2_section4 clear">
          <div class="contain2_section4_middle">
            <button>Claim</button>
          </div>
        </div>
      </div>
