...
export default function EditStandardAdminModeMiddleP2(props) {
  return (
    <>
      <div className="contain fl-left">
        <div className="block_section_1">
          ...
          <div className="contain_block_1 block-right fl-right">
            <div className="app9_edit">
              <img src={props.editon} alt="" srcset="" />
              Edit
            </div>
          </div>
        </div>
        ...
        <div className="block_section_4 clear">
          ...
          <div className="section_set_1">
            <div className="inner_section_4_a fl-left">{"props.pri"}</div>
            <div className="inner_section_4_b fl-right">
              <img src={props.priimg} className="mrbt6" alt="" />{" "}
              {props.pricont}
            </div>
          </div>
          <div className="clear hr_inner">
          ...
          <div className="section_set_1">
            <div className="inner_section_4_a fl-left">{props.token}</div>
            <div className="inner_section_4_b fl-right">{props.tokenamt}</div>
          </div>
          <div className="clear hr_inner">
            <hr />
          </div>
          <div className="section_set_1">
            <div className="inner_section_4_a fl-left">{props.unsold}</div>
            <div className="inner_section_4_b txt_nn fl-right">
              {props.unsoldcont}
            </div>
          </div>
          <div className="clear hr_inner">
          ...
          <div className="section_set_1">
            <div className="inner_section_4_a fl-left">{props.listed}</div>
            <div className="inner_section_4_b fl-right">
              {" "}
              <img src={props.listedimg} className="mrbt3" alt="" />{" "}
              {props.listencont}
            </div>
          </div>
          <div className="clear hr_inner">
          ...
          <div className="section_set_1">
            <div className="inner_section_4_a fl-left">{props.liq}</div>
            <div className="inner_section_4_b fl-right">{props.liqamt}</div>
          </div>
          <div className="clear hr_inner">
            <hr />
          </div>
